...
1. First remove the default rc.lua and replace it with this [modularized config](https://github.com/Gwynsav/modular-awm-default).
2. Add your wallpaper to theme/wall.jpg
3. Edit the contents of theme/init.lua 
...
Thanks for reading this, I hope it made your awesome journey eaiser.
