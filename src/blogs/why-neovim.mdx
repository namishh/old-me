...
Yup, I do not. Now the [vim motions](https://www.youtube.com/watch?v=y6VJBeZEDZU) is mostly the reason, people use it. Of course vim motions allow me to get blazingly fast 🚀  while writing [shitty code](/blog/how-to-not-make-quiz) that I will probably regret years later. But the main reason I use it is for the customization. Even after two years, I have not yet been able to learn the motions properly and still sometimes use my mouse in neovim (neovim has good mouse support). The main reason I use neovim is because of its customization options (and the fact that it can run on my ancient hardware laptop).
