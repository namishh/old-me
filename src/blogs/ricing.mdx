...
For cursors, unless you have a super specific niche theme in mind, you can just use [phinger cursors](https://github.com/phisch/phinger-cursors), they are the most popular one in unixporn.
...
2. [pfetch](https://github.com/dylanaraps/pfetch) - a smaller version of neofetch by the same author 
3. [nitch](https://github.com/ssleert/nitch) - a fetch script written in nim 
4. [bunnyfetch](https://github.com/Rosettea/bunnyfetch) - cutest fetch ever
